...
function Navbar() {
  ...
  return (
    <div className="flex relative bg-inherit text-gray-200 py-5 px-8 sm:px-12 md:px-14 lg:px-24 items-center justify-between border-b">
      ...
      <div className="flex items-center gap-2 h-10">
        ...
        <button className="py-2 sm:py-4  px-6 hidden sm:inline-flex items-center  text-2xl h-full font-bold rounded bg-gray-100 border-none transition text-gray-500">
          Hire me
        </button>
